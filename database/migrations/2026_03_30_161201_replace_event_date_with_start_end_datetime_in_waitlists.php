...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::table('waitlists', function (Blueprint $table) {
            $table->dateTime('start_datetime')->nullable()->after('user_id');
        ...
        try {
            Schema::table('waitlists', function (Blueprint $table) {
                $table->dropIndex('waitlists_hall_id_event_date_index');
            });
        } catch (\Exception $e) {
            // Index may not exist
        }
    ...
    public function down(): void
    {
        try {
            Schema::table('waitlists', function (Blueprint $table) {
                $table->dropIndex('waitlists_hall_id_start_datetime_end_datetime_index');
            });
        } catch (\Exception $e) {
            // Index may not exist
        }
